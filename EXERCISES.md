...
6. Create a function `get_channel_posts` that receives a channel `String`, and returns an `ExternResult<Vec<ActionHash>>` for all the posts that have been created in the given channel. 
